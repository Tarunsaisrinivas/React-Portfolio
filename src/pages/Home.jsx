...
const Home = () => {
  ...
  return (
    <div id="home" className="min-h-screen bg-gray-800">
      <div className="container flex flex-col items-center justify-between px-8 py-16 mx-auto md:flex-row md:py-28">
        {/* Text Content */}
...
const Button = ({ link, icon }) => {
  return (
    <a
      ...
      className="flex items-center justify-center px-4 py-2 transition duration-300 bg-gray-700 border-4 border-gray-800 rounded-2xl hover:bg-blue-400 hover:text-black"
    >
